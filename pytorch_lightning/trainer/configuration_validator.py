...
class ConfigValidator:
    ...
    def _check_on_keyboard_interrupt(self) -> None:
        ...
        for callback in self.trainer.callbacks:
            rank_zero_deprecation(callback)
            rank_zero_deprecation(type(callback))
            if is_overridden(method_name="on_keyboard_interrupt", instance=callback, parent=type(callback)):
                rank_zero_deprecation(
